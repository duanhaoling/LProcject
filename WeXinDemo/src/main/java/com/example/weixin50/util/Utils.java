...
import com.example.weixin50.MyApplication;
...
//            }
    ...
    public static void setStringSharedPreference(String key, String string) {
        SharedPreferences sp = MyApplication.getInstance().getApplicationContext()
                .getSharedPreferences(SHAREDPREFERENCES_NAME, Context.MODE_PRIVATE);
        Editor et = sp.edit();
        et.putString(key, string);
        et.commit();
    }
