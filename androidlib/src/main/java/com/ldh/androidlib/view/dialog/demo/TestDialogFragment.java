...
public class TestDialogFragment extends DialogFragment {
    ...
    public static TestDialogFragment newInstance(OnCallDialog call, boolean cancelable) {
        return newInstance(call, cancelable, null);
    }

    public static TestDialogFragment newInstance(OnCallDialog call, boolean cancelable, OnDialogCancelListener cancelListener) {
        TestDialogFragment instance = new TestDialogFragment();
