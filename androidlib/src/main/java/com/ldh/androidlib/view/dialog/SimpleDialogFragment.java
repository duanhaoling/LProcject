...
public class SimpleDialogFragment extends BaseDialogFragment {
    ...
    private ISimpleDialogListener mISimpleDialogListener;

    public void setISimpleDialogListener(ISimpleDialogListener iSimpleDialogListener) {
        this.mISimpleDialogListener = iSimpleDialogListener;
    }

    protected ISimpleDialogListener getDialogListener() {
        if (mISimpleDialogListener != null) {
            return mISimpleDialogListener;
        }
        final Fragment targetFragment = getTargetFragment();
        if (targetFragment != null) {
    ...
    public static class SimpleDialogBuilder extends BaseDialogBuilder<SimpleDialogBuilder> {
        ...
        public SimpleDialogFragment show() {
            return (SimpleDialogFragment) super.show();
        }
    }
